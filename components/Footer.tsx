      ...
      <div className="container-custom py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">Smartomation.ai</h3>
            <p className="text-gray-400 mb-4">
              Enterprise-grade AI automation platform. Build intelligent agents that think, act, and resolve.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Smartomation.ai. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
